...
var shop = function () {
    ...
    switch (shopOptionPrompt) {
        case "REFILL": //case for all caps input
        case "refill":
            if (playerMoney >= 7) {
                ...
                window.alert("You don't have have enough money!");
            }
            break;

        case "UPGRADE": //case for all caps input
        case "upgrade":
            if (playerMoney >= 7) {
                ...
                window.alert("Nice try, but you don't have enough money!");
            }

        case "LEAVE": //case for all caps input
        case "leave":
...
//function to generate a random numberi value 
